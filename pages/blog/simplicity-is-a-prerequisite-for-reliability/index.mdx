...
export const meta = {
  ...
  description:
    "Humans are not good with complexity. We can't hold much information in our working memory and thus makes us more likely to fail when working with complex systems.",
  date: "2023-05-18",
  tags: ["dev"],
}
...
We can’t hold much information in our working memory and thus makes us more likely to fail when working with complex systems. That’s also one of the reasons why complex systems are, in the long term, bound to fail.
