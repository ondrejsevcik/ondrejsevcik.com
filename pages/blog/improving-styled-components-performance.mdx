...
export const meta = {
  ...
  description:
    "Everybody knows that styled components are slow. But are they slow also if we combine them with some of the native CSS features?",
  image: "https://ondrejsevcik.com/images/styled-components-test.png",
  date: "2023-01-27",
  tags: ["tech"],
}
...
<Figure
  src="/images/styled-components-test.png"
